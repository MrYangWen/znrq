...
public class BluetoothLeClass extends Service{
    ...
    public final static String ACTION_DATA_AVAILABLE ="com.example.scannners.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA ="com.example.bluetooth.le.EXTRA_DATA";
    public final static String ACTION_DATA_UPDATE ="com.example.scannners.ACTION_DATA_UPDATE";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {      	
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                final Intent intent = new Intent(BluetoothLeClass.ACTION_GATT_CONNECTED);	
                mContext.sendBroadcast(intent);                   

            } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                if(mOnDisconnectListener!=null)
                	mOnDisconnectListener.onDisconnect(gatt);
                final Intent intent = new Intent(BluetoothLeClass.ACTION_GATT_DISCONNECTED);	
                mContext.sendBroadcast(intent);
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,BluetoothGattCharacteristic characteristic) {     	
            ...
            final Intent intent = new Intent(BluetoothLeClass.ACTION_DATA_UPDATE);
            intent.putExtra("BleRecData", data);	
            mContext.sendBroadcast(intent);         	
        }
    };
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic, boolean enabled) {
        ...
        boolean i=mBluetoothGatt.setCharacteristicNotification(characteristic, enabled);
