...
import com.cq.xm.znrq.http.exception.retrofitexception.AuthenticationException;
import com.cq.xm.znrq.view.rvlist.CHandler;
...
//            context.startActivity(new Intent(context, LogingActivity.class));
            ...
            Toast.makeText(context, "error1:" + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
        completeRefreshAndLoad();
    }
