 ...
 *         2015-3-5
 */
public class PtrCustomHeaderView extends View {
     ...
     * @param context
     */
    public PtrCustomHeaderView(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public PtrCustomHeaderView(Context context, AttributeSet attrs) {
     ...
     * @param defStyle
     */
    public PtrCustomHeaderView(Context context, AttributeSet attrs, int defStyle) {
