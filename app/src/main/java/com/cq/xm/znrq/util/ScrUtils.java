...
//
//        String fname = SDUtils.getSDCardPath() + sdf.format(new Date()) + ".png";
//
//        view.setDrawingCacheEnabled(true);
//
//        view.buildDrawingCache();
...
//    }
    ...
    public static  float getRealWidth(Context context,float width){
        return (float)(width*getScreenWidth(context))/750;
    }
}
