package com.cq.xm.znrq.view.calendar;
...
import static com.cq.xm.znrq.view.calendar.CalendarFactory.getMonthOfDayList;
...
//        init();
    ...
    public void init(@Nullable int[] date, @Nullable Date datetime) {

        if (date != null) {
            dateArr = date;
        }
        if (datetime != null) {
            dateArr = CalendarUtil.getYMD(datetime);
        }
        ...
        addOnPageChangeListener(new SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (listener != null) {
                    ...
                    listener.onChange((View) obs[0], (int) obs[1], (CalendarBean) obs[2]);
                }
...
//        mCaledarLayoutChangeListener = listener;
    ...
    public interface OnCalendarChangeListener {
        void onChange(View view, int postion, CalendarBean bean);
    }
